    ...
    <form wire:submit="save" class="space-y-6">
        <x-card>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <x-field label="Email" name="email"><input type="email" wire:model="email" class="w-full rounded-btn border border-border px-3 py-2.5 text-sm"></x-field>
                <x-field label="Password" name="password" :hint="$userId ? 'Leave blank to keep the current password.' : null">
