    ...
    <form wire:submit="save" class="space-y-6">
        <x-card>
            ...
            <div class="grid gap-4">
                <x-field :label="__('Question')" name="question"><input wire:model="question" class="w-full rounded-btn border border-border px-3 py-2.5 text-sm"></x-field>
                <x-field :label="__('Answer')" name="answer"><textarea wire:model="answer" rows="5" class="w-full rounded-btn border border-border px-3 py-2.5 text-sm"></textarea></x-field>
                <x-field :label="__('Category')" name="category"><input wire:model="category" class="w-full rounded-btn border border-border px-3 py-2.5 text-sm"></x-field>
            </div>
        </x-card>
        <x-card>
            ...
            <div class="flex flex-wrap gap-6">
                ...
                <label class="inline-flex items-center gap-2 text-sm font-semibold"><input type="checkbox" wire:model="is_featured" class="rounded border-border"> {{ __('Featured on home') }}</label>
