<div class="space-y-6">
    @unless ($embedded)
        <div class="flex items-center justify-between">
            <x-section-heading :title="__('Edit')" :description="__('Internal review only. This website does not grant loans.')" />
    ...
    <form wire:submit="save" class="space-y-6">
        <x-card>
            ...
            <x-field :label="__('Internal status')" name="status">
            ...
            <div class="mt-4">
                <x-field :label="__('Internal notes')" name="internal_notes">
